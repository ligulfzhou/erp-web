...
import useReturnOrderStatsByGoods from "@/hooks/useReturnOrderStatsByGoods";
import {ReturnOrderStatsByGoods, ReturnOrderStatsByItem} from "@/types/stats";
import React from "react";


const columns: ColumnsType<ReturnOrderStatsByGoods> = [
    {
        title: "商品编号",
        dataIndex: "goods_no",
...
const expandableColumns: TableColumnsType<ReturnOrderStatsByItem> = [
    {
        title: "sku_no",
        dataIndex: "sku_no",
        render: (_, record) => (
...
export default function Order() {
    ...
    const {returnOrderStats, key, isLoading, total} = useReturnOrderStatsByGoods()
